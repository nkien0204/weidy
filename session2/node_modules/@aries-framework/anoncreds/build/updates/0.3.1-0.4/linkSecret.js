...
async function migrateLinkSecretToV0_4(agent) {
    ...
    if (!defaultLinkdSecret) {
        ...
        agent.config.logger.debug(`Default link secret record with record id ${defaultLinkdSecret.id} and link secret id ${defaultLinkdSecret.linkSecretId} found. Skipping...`);
    }
