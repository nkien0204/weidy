...
class LegacyIndyCredentialFormatService {
    ...
    async processOffer(agentContext, { attachment, credentialRecord }) {
        ...
        if (!credOffer.schema_id.match(utils_1.legacyIndySchemaIdRegex) ||
            !credOffer.cred_def_id.match(utils_1.legacyIndyCredentialDefinitionIdRegex)) {
    ...
    async acceptOffer(agentContext, { credentialRecord, attachmentId, offerAttachment, credentialFormats, }) {
        ...
        if (!credentialOffer.cred_def_id.match(utils_1.legacyIndyCredentialDefinitionIdRegex)) {
