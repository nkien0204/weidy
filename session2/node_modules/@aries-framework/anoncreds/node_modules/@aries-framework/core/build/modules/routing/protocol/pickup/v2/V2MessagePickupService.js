...
let V2MessagePickupService = class V2MessagePickupService {
    constructor(messageRepository, messageHandlerRegistry, mediationRecipientService) {
    ...
    registerMessageHandlers(messageHandlerRegistry) {
        messageHandlerRegistry.registerMessageHandler(new handlers_1.StatusRequestHandler(this));
        messageHandlerRegistry.registerMessageHandler(new handlers_1.DeliveryRequestHandler(this));
        messageHandlerRegistry.registerMessageHandler(new handlers_1.MessagesReceivedHandler(this));
        messageHandlerRegistry.registerMessageHandler(new handlers_1.StatusHandler(this.mediationRecipientService));
        messageHandlerRegistry.registerMessageHandler(new handlers_1.MessageDeliveryHandler(this.mediationRecipientService));
    }
};
V2MessagePickupService = __decorate([
    (0, plugins_1.injectable)(),
    __param(0, (0, plugins_1.inject)(constants_1.InjectionSymbols.MessageRepository)),
    __metadata("design:paramtypes", [Object, MessageHandlerRegistry_1.MessageHandlerRegistry,
