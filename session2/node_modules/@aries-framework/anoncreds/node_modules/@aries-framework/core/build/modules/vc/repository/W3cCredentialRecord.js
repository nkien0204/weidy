...
const W3cVerifiableCredential_1 = require("../models/credential/W3cVerifiableCredential");
class W3cCredentialRecord extends BaseRecord_1.BaseRecord {
    ...
    getTags() {
        ...
        return Object.assign(Object.assign({}, this._tags), { issuerId: this.credential.issuerId, subjectIds: this.credential.credentialSubjectIds, schemaIds: this.credential.credentialSchemaIds, contexts: stringContexts, proofTypes: this.credential.proofTypes, givenId: this.credential.id });
    }
}
