...
export declare const DID_INDY_REGEX: RegExp;
/**
 ...
 */
export declare function isLegacySelfCertifiedDid(did: string, verkey: string): boolean;
export declare function legacyIndyDidFromPublicKeyBase58(publicKeyBase58: string): string;
