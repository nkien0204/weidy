...
class DidsModuleConfig {
    ...
    get registrars() {
        ...
        let registrars = (_a = this.options.registrars) !== null && _a !== void 0 ? _a : [new methods_1.KeyDidRegistrar(), new methods_1.PeerDidRegistrar()];
    ...
    get resolvers() {
        ...
        let resolvers = (_a = this.options.resolvers) !== null && _a !== void 0 ? _a : [new methods_1.WebDidResolver(), new methods_1.KeyDidResolver(), new methods_1.PeerDidResolver()];
