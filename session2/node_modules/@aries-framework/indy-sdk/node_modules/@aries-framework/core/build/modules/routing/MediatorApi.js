...
const handlers_2 = require("./protocol/pickup/v1/handlers");
const MediatorService_1 = require("./services/MediatorService");
let MediatorApi = class MediatorApi {
    constructor(messageHandlerRegistry, mediationService, messagePickupService, 
    // Only imported so it is injected and handlers are registered
    v2MessagePickupService, messageSender, eventEmitter, agentContext, connectionService, config) {
    ...
    registerMessageHandlers(messageHandlerRegistry) {
        ...
        messageHandlerRegistry.registerMessageHandler(new handlers_2.BatchPickupHandler(this.messagePickupService));
        messageHandlerRegistry.registerMessageHandler(new handlers_2.BatchHandler(this.eventEmitter));
